...
var Missile = class extends CustomType {
  constructor(name, damage_dealt, carried, expended, hit, miss, soft_killed, hard_killed) {
    super();
    this.name = name;
    this.damage_dealt = damage_dealt;
...
var DefensiveMissile = class extends CustomType {
  constructor(name, carried, expended, targets, interceptions, successes) {
    super();
    this.name = name;
    this.carried = carried;
    this.expended = expended;
...
var Craft = class extends CustomType {
  constructor(name, class$2, carried, lost, sorties, anti_ship_weapons, space_superiority_weapons) {
    super();
    this.name = name;
    this.class = class$2;
    this.carried = carried;
    ...
    this.anti_ship_weapons = anti_ship_weapons;
    this.space_superiority_weapons = space_superiority_weapons;
  }
};
...
function craft_missile_card(missile, sortied, miss, soft_killed, hard_killed) {
  let _block;
  let _pipe = missile.damage_dealt;
  ...
  return div(
    ...
    toList([
      p(
        ...
        toList([text3(missile.name + " Missile")])
      ),
      p(
        toList([]),
        toList([
          ...
          br(toList([])),
          text3(
            "Max Damage Each: " + float_to_string(missile.max_damage_per_round)
          ),
          br(toList([])),
          text3("Expended: " + to_string(missile.fired)),
          br(toList([])),
          text3("Hits: " + to_string(missile.hits)),
          br(toList([])),
          text3("Carried: " + to_string(sortied)),
          br(toList([])),
          text3("Miss: " + to_string(miss)),
          br(toList([])),
          text3("Soft Kills: " + to_string(soft_killed)),
          br(toList([])),
          text3("Hard Kills: " + to_string(hard_killed))
        ])
      )
    ])
  );
...
function defensive_missile_card(missile) {
  let _block;
  let _pipe = divideFloat(
    identity(missile.successes),
    identity(missile.interceptions)
  );
  let _pipe$1 = to_precision(_pipe, 2);
  _block = float_to_string(_pipe$1);
  let success_rate = _block;
  return div(
    toList([class$("cell")]),
    toList([
      p(toList([class$("title is-5")]), toList([text3(missile.name)])),
      p(
        toList([]),
        toList([
          text3("Carried: " + to_string(missile.carried)),
          br(toList([])),
          text3("Expended: " + to_string(missile.expended)),
          br(toList([])),
          text3("Targets Assigned: " + to_string(missile.targets)),
          br(toList([])),
          text3("Interceptions: " + to_string(missile.interceptions)),
          br(toList([])),
          text3("Successes: " + to_string(missile.successes)),
          br(toList([])),
          text3("Success Rate: " + success_rate)
        ])
      )
    ])
  );
...
function weapon_card(weapon) {
  ...
  if ($ instanceof GunDetails) {
    ...
    let sortied = $.sortied;
    let miss = $.miss;
    let soft_killed = $.soft_killed;
    let hard_killed = $.hard_killed;
    return craft_missile_card(weapon, sortied, miss, soft_killed, hard_killed);
  }
}
        ...
        toList([
          p(
            ...
            toList([
              ...
              text3("Expended: " + to_string(missile.expended)),
              br(toList([])),
              text3("Hit: " + to_string(missile.hit)),
              br(toList([])),
              text3("Miss: " + to_string(missile.miss)),
              br(toList([])),
              text3("Soft Kills: " + to_string(missile.soft_killed)),
              br(toList([])),
              text3("Hard Kills: " + to_string(missile.hard_killed))
            ])
          )
        ])
      )
...
function ship_missile_damage_dealt(ship) {
  let _pipe = ship.anti_ship_missiles;
  let _pipe$1 = map(_pipe, (m) => {
    return m.damage_dealt;
  });
  let _pipe$2 = reduce(_pipe$1, (a, b) => {
    return a + b;
  });
...
function ship_gun_damage_dealt(ship) {
...
function craft_anti_ship_damage_dealt(craft) {
        ...
        toList([
          ...
          div(
            ...
            toList([
              ...
              br(toList([])),
              text3(
                "Damage Dealt: " + float_to_string(
                  craft_anti_ship_damage_dealt(craft)
                )
              ),
              br(toList([])),
              ...
              h4(
                ...
                toList([text3("Anti Ship Weapons")])
              ),
              weapon_grid,
              h4(
                toList([class$("title is-4")]),
                toList([text3("Space Superiority Weapons")])
              ),
              div(
                toList([class$("fixed-grid has-4-cols")]),
                toList([
                  div(
                    toList([class$("grid")]),
                    (() => {
                      let _pipe$1 = craft.space_superiority_weapons;
  ...
  return div(
    ...
    toList([
      div(
        ...
        toList([
          p(toList([class$("card-header-title")]), toList([text3(craft.name)]))
        ])
      ),
      div(
        ...
        toList([
          div(
            ...
            toList([
              text3(craft.class),
              br(toList([])),
              text3("Anti Ship Damage Dealt: " + float_to_string(damage_dealt)),
              br(toList([])),
              text3("Carried: " + to_string(craft.carried)),
              br(toList([])),
              text3("Lost: " + to_string(craft.lost)),
...
function ship_damage_dealt(ship) {
  return ship_missile_damage_dealt(ship) + ship_gun_damage_dealt(ship);
}
function ship_detail(ship) {
  let _block;
  let _pipe = ship.anti_ship_missiles;
  _block = map(_pipe, missile_card);
  let missile_cards = _block;
  let missile_grid = div(
    toList([class$("fixed-grid has-4-cols")]),
    toList([div(toList([class$("grid")]), missile_cards)])
  );
  let _block$1;
  let _pipe$1 = ship.anti_ship_weapons;
  _block$1 = map(_pipe$1, weapon_card);
  let gun_cards = _block$1;
  let gun_grid = div(
    toList([class$("fixed-grid has-4-cols")]),
  ...
  let defensive_missile_cards = _block$3;
  let defensive_missile_grid = div(
    toList([class$("fixed-grid has-4-cols")]),
      ...
      div(
        ...
        toList([
          ...
          div(
            toList([class$("content")]),
            toList([
              text3("Class: " + ship.class),
              br(toList([])),
              text3("Damage Taken: " + to_string(ship.damage_taken)),
              br(toList([])),
              text3(
                "Antiship Damage Dealt: " + float_to_string(
                  ship_damage_dealt(ship)
                )
              ),
              br(toList([])),
              text3(
                "Antiship Gun Damage Dealt: " + float_to_string(
                  ship_gun_damage_dealt(ship)
                )
              ),
              br(toList([])),
              text3(
                "Antiship Missile Damage Dealt: " + float_to_string(
                  ship_missile_damage_dealt(ship)
                )
              )
            ])
          ),
...
function total_craft_damage_dealt(crafts) {
  let _pipe = crafts;
  let _pipe$1 = map(_pipe, craft_anti_ship_damage_dealt);
  let _pipe$2 = reduce(_pipe$1, (a, b) => {
    return a + b;
  });
  let _pipe$3 = unwrap(_pipe$2, 0);
...
function player_box(player) {
  let _block;
  let _pipe = total_damage_dealt(player.ships) + total_craft_damage_dealt(
    player.craft
  );
  _block = to_precision(_pipe, 2);
  let total_damage = _block;
  let _block$1;
  let _pipe$1 = player.craft;
  _block$1 = map(_pipe$1, craft_card);
  let craft_cards = _block$1;
  let _block$2;
  let _pipe$2 = player.ships;
  _block$2 = map(_pipe$2, ship_card);
  let ship_cards = _block$2;
  let cards = append(ship_cards, craft_cards);
  return div(
    toList([class$("box")]),
    toList([
      div(
...
function team_box(team, team_id, winner) {
  let _block;
  if (team_id instanceof TeamA) {
    _block = "Team A";
  } else {
    _block = "Team B";
  }
  let team_name = _block;
  let _block$1;
  let $ = isEqual(winner, team_id);
  if ($) {
    _block$1 = team_name + " (Winner)";
  } else {
    _block$1 = team_name;
  }
  let team_name_with_winner = _block$1;
  return div(
    ...
    toList([
      div(
        ...
        prepend(
          p(
            toList([class$("title is-3")]),
            toList([text3(team_name_with_winner)])
          ),
          (() => {
...
function view(state) {
  let team_a_box = team_box(
    state.report.team_a,
    new TeamA(),
    state.report.winning_team
  );
  let team_b_box = team_box(
    state.report.team_b,
    new TeamB(),
    state.report.winning_team
  );
...
function parse_int_element(input2) {
  let $ = parse_string_element(new None(), input2);
  if ($.isOk()) {
...
function parse_float_element(input2) {
  let $ = parse_string_element(new None(), input2);
  if ($.isOk()) {
    let string_value = $[0][0];
    let next_input = $[0][1];
...
function parse_anti_ship_craft_missile_inner(loop$parse_state, loop$input) {
  while (true) {
    ...
    if (!$.isOk()) {
        ...
        (_use0) => {
          ...
          return parse_anti_ship_craft_missile_inner(
            (() => {
              ...
              return new ParseAntiShipCraftMissileState(
                new Some(name),
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "IndividualDamagePotential") {
      let next_input = $[0][1];
      return try$(
        parse_float_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Hits") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "TotalSortied") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Misses") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Softkills") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
          let soft_kill = _use0[0];
          let next_input_2 = _use0[1];
          return parse_anti_ship_craft_missile_inner(
            (() => {
              let _record = parse_state;
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Hardkills") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
          let hard_kill = _use0[0];
          let next_input_2 = _use0[1];
          return parse_anti_ship_craft_missile_inner(
            (() => {
              let _record = parse_state;
      ...
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_anti_ship_craft_missile_inner(parse_state, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      ...
      return new Error2(
        concat2(
          toList(["Unexpected data at anti-ship craft missile: ", data])
        )
      );
    } else {
      let next_input = $[0][1];
...
function parse_defensive_missile_inner(loop$parse_state, loop$input) {
  while (true) {
    ...
    if (!$.isOk()) {
      ...
      return try$(
        ...
        (_use0) => {
          let name = _use0[0];
          let next_input_2 = _use0[1];
          return parse_defensive_missile_inner(
            (() => {
              let _record = parse_state;
              return new ParseDefensiveMissileState(
                new Some(name),
                _record.carried,
                _record.expended,
                _record.targets,
                _record.interceptions,
                _record.successes
              );
            })(),
            next_input_2
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "TotalTargets") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "TotalInterceptions") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
          let interceptions = _use0[0];
          let next_input_2 = _use0[1];
          return parse_defensive_missile_inner(
            (() => {
              let _record = parse_state;
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "TotalSuccesses") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
          let successes = _use0[0];
          let next_input_2 = _use0[1];
          return parse_defensive_missile_inner(
            (() => {
              let _record = parse_state;
      ...
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_defensive_missile_inner(parse_state, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      if (parse_state instanceof ParseDefensiveMissileState && parse_state.name instanceof Some && parse_state.carried instanceof Some && parse_state.expended instanceof Some && parse_state.targets instanceof Some && parse_state.interceptions instanceof Some && parse_state.successes instanceof Some) {
        let name = parse_state.name[0];
        let carried = parse_state.carried[0];
        let expended = parse_state.expended[0];
        let targets = parse_state.targets[0];
        let interceptions = parse_state.interceptions[0];
        let successes = parse_state.successes[0];
        return new Ok(
          [
            new DefensiveMissile(
              name,
              carried,
              expended,
              targets,
...
function parse_defensive_missile(input2) {
  return parse_defensive_missile_inner(
    new ParseDefensiveMissileState(
      new None(),
      new None(),
      new None(),
      new None(),
...
function parse_defensive_missiles_inner(loop$defensive_missiles, loop$input) {
  while (true) {
    let defensive_missiles = loop$defensive_missiles;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "DefensiveMissileReport") {
      let next_input = $[0][1];
      return try$(
        parse_defensive_missile(next_input),
        (_use0) => {
          let missile = _use0[0];
          let next_input_2 = _use0[1];
          return parse_defensive_missiles_inner(
            prepend(missile, defensive_missiles),
            next_input_2
          );
        }
      );
      ...
      let next_input = $[0][1];
      return new Ok([defensive_missiles, next_input]);
    } else if ($.isOk() && $[0][0] instanceof Data) {
      let data = $[0][0][0];
      return new Error2(
        concat2(toList(["Unexpected data at defenses: ", data]))
      ...
      let next_input = $[0][1];
      loop$defensive_missiles = defensive_missiles;
      loop$input = next_input;
    }
  }
}
function parse_defensive_missiles(input2) {
  return parse_defensive_missiles_inner(toList([]), input2);
}
...
function parse_anti_ship_weapon_inner(loop$parse_state, loop$input) {
  while (true) {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "RoundsCarried") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
          let rounds_carried = _use0[0];
          let next_input_2 = _use0[1];
          return parse_anti_ship_weapon_inner(
            (() => {
              let _record = parse_state;
...
function parse_defenses_inner(loop$defenses, loop$input) {
  while (true) {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "MissileReports") {
      let next_input = $[0][1];
      return try$(
        parse_defensive_missiles(next_input),
        (_use0) => {
          let missiles = _use0[0];
          let next_input_2 = _use0[1];
          return parse_defenses_inner(
            (() => {
              let _record = defenses;
...
function parse_missile_inner(loop$parse_state, loop$input) {
  while (true) {
    let parse_state = loop$parse_state;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      ...
      return try$(
        ...
        (_use0) => {
          let name = _use0[0];
          let next_input_2 = _use0[1];
          return parse_missile_inner(
            (() => {
              let _record = parse_state;
              return new ParseMissileState(
                new Some(name),
                _record.damage_dealt,
                _record.carried,
                _record.expended,
      ...
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_missile_inner(parse_state, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      if (parse_state instanceof ParseMissileState && parse_state.name instanceof Some && parse_state.damage_dealt instanceof Some && parse_state.carried instanceof Some && parse_state.expended instanceof Some && parse_state.hit instanceof Some && parse_state.miss instanceof Some && parse_state.soft_killed instanceof Some && parse_state.hard_killed instanceof Some) {
        let name = parse_state.name[0];
        let damage = parse_state.damage_dealt[0];
        let carried = parse_state.carried[0];
        let expended = parse_state.expended[0];
      ...
      let data = $[0][0][0];
      return new Error2(
        concat2(toList(["Unexpected data at missile: ", data]))
      );
    } else {
      let next_input = $[0][1];
      loop$parse_state = parse_state;
...
function parse_strike_inner(loop$missiles, loop$input) {
  while (true) {
    ...
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Missiles") {
      let next_input = $[0][1];
      return try$(
        parse_missiles(next_input),
        (_use0) => {
          let missiles$1 = _use0[0];
          let next_input_2 = _use0[1];
          return parse_strike_inner(missiles$1, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag) {
      let next_input = $[0][1];
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_strike_inner(missiles, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      ...
      let data = $[0][0][0];
      return new Error2(
        concat2(toList(["Unexpected data at strike: ", data]))
      );
    } else {
      let next_input = $[0][1];
      loop$missiles = missiles;
...
function parse_strike(input2) {
  return parse_strike_inner(toList([]), input2);
}
function parse_ship_inner(loop$parse_state, loop$input) {
  while (true) {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Strike") {
      let next_input = $[0][1];
      return try$(
        parse_strike(next_input),
        (_use0) => {
          let weapons = _use0[0];
          let next_input$1 = _use0[1];
          return parse_ship_inner(
...
function parse_craft_strike_weapons_inner(craft_weapon_reports, input2) {
  let $ = signal(input2);
  if (!$.isOk()) {
    let e = $[0];
    return new Error2(input_error_to_string(e));
    ...
    return try$(
      ...
      (_use0) => {
        let missile = _use0[0];
        let next_input_2 = _use0[1];
        return parse_craft_strike_weapons_inner(
    ...
    return try$(
      ...
      (_use0) => {
        ...
        let next_input_2 = _use0[1];
        return parse_craft_strike_weapons_inner(
          prepend(gun, craft_weapon_reports),
          next_input_2
        );
      }
    );
    ...
    let next_input = $[0][1];
    return try$(
      parse_anti_ship_craft_missile(next_input),
      (_use0) => {
        let missile = _use0[0];
        let next_input_2 = _use0[1];
        return parse_craft_strike_weapons_inner(
    ...
    let next_input = $[0][1];
    return new Ok([craft_weapon_reports, next_input]);
  } else if ($.isOk() && $[0][0] instanceof Data) {
    let data = $[0][0][0];
    return new Error2(
      concat2(toList(["Unexpected data at craft strike: ", data]))
    );
  } else {
    let next_input = $[0][1];
    return parse_craft_strike_inner(craft_weapon_reports, next_input);
  }
}
function parse_craft_strike_inner(loop$craft_weapon_reports, loop$input) {
  while (true) {
    let craft_weapon_reports = loop$craft_weapon_reports;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "GeneralWeapons") {
      let next_input = $[0][1];
      return try$(
        parse_craft_strike_weapons(next_input),
        (_use0) => {
          let weapons = _use0[0];
          let next_input_2 = _use0[1];
          return parse_craft_strike_inner(weapons, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag) {
      let next_input = $[0][1];
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_craft_strike_inner(craft_weapon_reports, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      ...
      let next_input = $[0][1];
      loop$craft_weapon_reports = craft_weapon_reports;
      loop$input = next_input;
    }
  }
}
function parse_craft_strike_weapons(input2) {
  return parse_craft_strike_weapons_inner(toList([]), input2);
}
function parse_craft_strike(input2) {
  return parse_craft_strike_inner(toList([]), input2);
}
function parse_craft_report_inner(loop$parse_state, loop$input) {
  while (true) {
    let parse_state = loop$parse_state;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "DesignName") {
      let next_input = $[0][1];
      return try$(
        parse_string_element(new None(), next_input),
        (_use0) => {
          let name = _use0[0];
          let next_input_2 = _use0[1];
          return parse_craft_report_inner(
            (() => {
              let _record = parse_state;
              return new ParseCraftState(
                new Some(name),
                _record.class,
                _record.carried,
                _record.lost,
                _record.sorties,
                _record.anti_ship_weapons,
                _record.space_superiority_weapons
              );
            })(),
            next_input_2
          );
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "FrameName") {
      let next_input = $[0][1];
      return try$(
        parse_string_element(new None(), next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Carried") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Lost") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "SortiesFlown") {
      let next_input = $[0][1];
      return try$(
        parse_int_element(next_input),
        (_use0) => {
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "StrikeReport") {
      let next_input = $[0][1];
      return try$(
        parse_craft_strike(next_input),
        (_use0) => {
          let weapons = _use0[0];
          let next_input$1 = _use0[1];
          return parse_craft_report_inner(
    ...
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "SpaceSuperiorityReport") {
      let next_input = $[0][1];
      return try$(
        parse_craft_strike(next_input),
        (_use0) => {
      ...
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_craft_report_inner(parse_state, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      if (parse_state instanceof ParseCraftState && parse_state.name instanceof Some && parse_state.class instanceof Some && parse_state.carried instanceof Some && parse_state.lost instanceof Some && parse_state.sorties instanceof Some) {
        let name = parse_state.name[0];
        let class$2 = parse_state.class[0];
        let carried = parse_state.carried[0];
        let lost = parse_state.lost[0];
        let sorties = parse_state.sorties[0];
        let anti_ship_weapons = parse_state.anti_ship_weapons;
        let space_superiority_weapons = parse_state.space_superiority_weapons;
        return new Ok(
          [
            new Craft(
              name,
        ...
        return new Error2("Missing craft data");
      }
    } else if ($.isOk() && $[0][0] instanceof Data) {
      let data = $[0][0][0];
      return new Error2(
        concat2(toList(["Unexpected data at craft: ", data]))
      );
    } else {
      let next_input = $[0][1];
      loop$parse_state = parse_state;
...
function parse_craft_report(input2) {
  return parse_craft_report_inner(
    new ParseCraftState(
      new None(),
      new None(),
...
function parse_craft_inner(loop$craft, loop$input) {
  while (true) {
    let craft = loop$craft;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "CraftBattleReport") {
      let next_input = $[0][1];
      return try$(
        parse_craft_report(next_input),
        (_use0) => {
          let new_craft = _use0[0];
          let next_input_2 = _use0[1];
          return parse_craft_inner(prepend(new_craft, craft), next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag) {
      let next_input = $[0][1];
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_craft_inner(craft, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      return new Ok([craft, next_input]);
    } else if ($.isOk() && $[0][0] instanceof Data) {
      let data = $[0][0][0];
      return new Error2(
        concat2(toList(["Unexpected data at craft: ", data]))
...
function parse_craft(input2) {
  return parse_craft_inner(toList([]), input2);
}
  ...
  while (true) {
    ...
    if (!$.isOk()) {
      ...
      return try$(
        ...
        (_use0) => {
          ...
          return parse_player_inner(
            (() => {
              let _record = parse_state;
              return new ParsePlayerState(_record.name, ships, _record.craft);
            })(),
            next_input_2
          );
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "Craft") {
      let next_input = $[0][1];
      return try$(
        parse_craft(next_input),
        (_use0) => {
          let craft = _use0[0];
          let next_input_2 = _use0[1];
          return parse_player_inner(
            (() => {
              let _record = parse_state;
              return new ParsePlayerState(_record.name, _record.ships, craft);
            })(),
            next_input_2
          );
        }
      ...
      if (parse_state instanceof ParsePlayerState && parse_state.name instanceof Some) {
        ...
        let craft = parse_state.craft;
        return new Ok([new Player(name, ships, craft), next_input]);
      } else {
...
function parse_player(input2) {
  return parse_player_inner(
    new ParsePlayerState(new None(), toList([]), toList([])),
    input2
  );
}
...
function parse_report_inner(loop$parse_state, loop$input) {
  while (true) {
    let parse_state = loop$parse_state;
    let input2 = loop$input;
    let $ = signal(input2);
    if (!$.isOk()) {
      let e = $[0];
      return new Error2(input_error_to_string(e));
    } else if ($.isOk() && $[0][0] instanceof ElementStart && $[0][0][0] instanceof Tag && $[0][0][0].name instanceof Name && $[0][0][0].name.uri === "" && $[0][0][0].name.local === "WinningTeam") {
      let next_input = $[0][1];
      return try$(
        parse_string_element(new None(), next_input),
        (_use0) => {
          let winning_team_string = _use0[0];
          let next_input$1 = _use0[1];
          if (winning_team_string === "TeamA") {
            return parse_report_inner(
              (() => {
                let _record = parse_state;
                return new ParseReportState(
                  new Some(new TeamA()),
                  _record.team_a,
                  _record.team_b
                );
          ...
          } else if (winning_team_string === "TeamB") {
            return parse_report_inner(
              (() => {
                let _record = parse_state;
                return new ParseReportState(
            ...
            return new Error2(
              concat2(
                toList(["Unexpected winning team: ", winning_team_string])
              )
            );
          }
        }
      ...
      return try$(
        skip_tag(next_input),
        (next_input_2) => {
          return parse_report_inner(parse_state, next_input_2);
        }
      );
    } else if ($.isOk() && $[0][0] instanceof ElementEnd) {
      let next_input = $[0][1];
      if (parse_state instanceof ParseReportState && parse_state.winning_team instanceof Some && parse_state.team_a instanceof Some && parse_state.team_b instanceof Some) {
        let winning_team = parse_state.winning_team[0];
        let team_a = parse_state.team_a[0];
...
function parse_report_element(input2) {
  return parse_report_inner(
    new ParseReportState(new None(), new None(), new None()),
    input2
  );
}
...
function view2(state) {
  ...
  let $ = state.report;
  if ($ instanceof None) {
    _block = upload_form(state.error_message);
  } else {
    let report = $[0];
  ...
  let content = _block;
  return div(toList([class$("container is-fluid")]), toList([content]));
}
function main() {
